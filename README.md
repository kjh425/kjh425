...
**2년 이상의 실무 경험**을 통해  
단순 기능 구현을 넘어 **실제 서비스 운영 환경에서 발생하는 성능, 보안, 배포, 장애 대응까지 직접 다뤄왔으며**,  
사용자 경험과 시스템 안정성을 동시에 고려하는 개발을 지향합니다.
...
- **설명**  
  대한민국을 대표하는 공공 문화기관의 공식 웹 서비스로,  
  **대규모 트래픽과 높은 접근성·보안 요구사항을 충족해야 하는 국가 단위 서비스**
- **기여 내용**
  - Java/Spring/JSP 기반 운영 및 유지보수
  - Oracle DB 기반 대량 데이터 처리
  - 웹 접근성 및 보안 취약점 대응
  - 실 서비스 장애 분석 및 성능 개선
...
- **설명**  
  기업 및 기관을 대상으로 한 **복지 포인트 기반 커머스 플랫폼**
- **기여 내용**
  - Spring Boot 기반 API 설계 및 구현
  - 결제·포인트·회원 관리 로직 개발
  - React 기반 프론트엔드 일부 기능 구현
  - 실 운영 환경 배포 및 유지보수
...
<p align="center">
  ...
  <a href="https://instagram.com/k0j4h25"><img src="https://img.shields.io/badge/Instagram-E4405F?style=for-the-badge&logo=instagram&logoColor=white" /></a>
</p>
